...
export const mainNavList = [
  ...
  { label: "Faq", link: "/dashboard/faq", subNav: [] },
  {
    ...
    link: "/dashboard/provider-category",
    subNav: [],
  },
...

  {
    ...
    subNav: [
      { label: "Contract Fees", link: "/dashboard/contract-fees" },
      {
        ...
        link: "/dashboard/contract-token-types",
      },
    ],
  },
  ...
  { label: "Transaction", link: "/dashboard/transaction", subNav: [] },
  {
    ...
    link: "/dashboard/transaction-limit",
    subNav: [],
  },
...
// ✅ Bottom Navigation
export const bottomNavList = [{ label: "Logout", link: null, subNav: [] }];
...
export const getIconForNav = (item, props = {}) => {
  ...
  switch (item.label) {
    ...
    case "Provider Category":
      return <WorkspacesIcon style={style} />;
    case "Provider":
      return <StoreIcon style={style} />;
    case "Manage Providers":
      return <MiscellaneousServicesIcon style={style} />;

    // Sub-navigation under "Manage Providers"
    ...
    case "Blog Category":
      return <CategoryIcon style={style} />;
    case "Logout":
