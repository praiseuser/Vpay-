        ...
        <Box sx={styles.cryptoContainer}>
          <Box sx={styles.cryptoColumn}>
            <Box sx={styles.cryptoItem}>
              <img src="/bitcoin.jpeg" alt="Crypto Avatar" width={30} height={30} style={{ marginRight: 8 }} />
              <Box sx={{ flex: 1 }}>
            ...
            <Box sx={styles.cryptoItem}>
              <img src="/BNB.webp" alt="Crypto Avatar" width={30} height={30} style={{ marginRight: 8 }} />
              <Box sx={{ flex: 1 }}>
          ...
          <Box sx={styles.cryptoColumn}>
            <Box sx={styles.cryptoItem}>
              <img src="/chain.png" alt="Crypto Avatar" width={30} height={30} style={{ marginRight: 8 }} />
              <Box sx={{ flex: 1 }}>
            ...
            <Box sx={styles.cryptoItem}>
              <img src="/buu.jpeg" alt="Crypto Avatar" width={30} height={30} style={{ marginRight: 8 }} />
              <Box sx={{ flex: 1 }}>
